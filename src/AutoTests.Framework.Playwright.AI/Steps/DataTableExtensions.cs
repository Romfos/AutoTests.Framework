namespace AutoTests.Framework.Playwright.AI.Steps;

public static class DataTableExtensions
{
    public static IEnumerable<(string, string)> AsNameValueTable(this string[][] values)
    {
        if (!(values.Length > 1
    ...
    public static IEnumerable<string> AsSingleColumnNameTable(this string[][] values)
    {
        if (!(values.Length > 1

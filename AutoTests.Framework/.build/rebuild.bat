Path = C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\MSBuild\15.0\Bin
MSBuild ..\AutoTests.Framework.Core\AutoTests.Framework.Core.csproj /p:Configuration=Release
MSBuild ..\AutoTests.Framework.Models\AutoTests.Framework.Models.csproj /p:Configuration=Release

nuget.exe pack ..\AutoTests.Framework.Core\AutoTests.Framework.Core.csproj -properties Configuration=Release
nuget.exe pack ..\AutoTests.Framework.Models\AutoTests.Framework.Models.csproj -properties Configuration=Release
